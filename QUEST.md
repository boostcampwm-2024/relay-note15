...
#### J261_최재원
➕ 추가사항 : `뽀모도로 기법`을 사용해서 시간을 정해놓고 진행해보기 (하루 이상!)

[뽀모도로기법이란?](https://github.com/boostcampwm-2024/relay-note15/blob/main/week3/%ED%95%B4%EC%84%9D%EA%B3%B5%EC%9C%A0.md#j261_%EC%B5%9C%EC%9E%AC%EC%9B%90)
...
> ### 제거사유 : 위의 에러발생 기록 퀘스트와 비슷하다고 생각하여 새로운 퀘스트 추가

## week03 J094_문준호
### 함께 자라기 p.120 "커뮤니케이션과 협력"
✔️ 퀘스트: 라운지를 활성화시켜 주세요. <br>
✔️ 수행 기준: 
  - 혼자 개발,개선 하는날 라운지에서 모각코 2시간 참여하기
  - 라운지에 들어갈 때 random에 모각코 홍보하기
